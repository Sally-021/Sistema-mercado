...
public class Caixa extends JFrame {
	...
	public Caixa() {
		...
		bFinalizarCompra.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(!mercado.getListaCompra().isEmpty()) {
					...
					formaPagamento.setLocationRelativeTo(null);
		...
		bFinalizarCompra.setBounds(48, 388, 185, 23);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			 mercado.cancelarCompra();
				Conclusao j = new Conclusao();
		...
		btnNewButton.setBounds(243, 388, 159, 23);
