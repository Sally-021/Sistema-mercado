...
public class JPrincipal extends JFrame {
	...
	public JPrincipal() {
		...
		JButton bEncerrar = new JButton("Encerrar programa");
		bEncerrar.setFont(new Font("Tahoma", Font.BOLD, 11));
		bEncerrar.setBackground(SystemColor.control);
		bEncerrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				dispose();
			}
		});
		bEncerrar.setBounds(725, 483, 139, 23);
		contentPane.add(bEncerrar);
	}
}
